    ...
    <div id="content-wrapper" class="d-flex flex-column p-3">
        ...
        <div id="content">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Input Karyawan Baru</h1>
            </div>
            <!-- Begin Page Content -->
            <form class="row g-3" action="../viewsAction/createEmployeeAction.php" method="post">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" name="employeeName" class="form-control" id="inputPassword4" required placeholder="nama">
                </div>
                ...
                <div class="col-12 mb-2">
                    ...
                    <input type="text" class="form-control" name="phoneNumber" id="inputAddress2" required placeholder="nomor telepon">
                </div>
                <div class="col-md-6 mb-2">
                    <label for="" class="form-label">Tanggal Lahir</label>
                    <input type="date" min="{{ now()->toDateString('Y-m-d') }}" name="birthDate"
                           class="form-control" required>
                </div>
                <div class="col-md-2">
                    <label for="inputZip" class="form-label">Jabatan</label>
                    <input type="text" name="position" class="form-control" id="inputZip" placeholder="jabatan">
                </div>
                <div class="col-md-4">
                    <label for="inputState" class="form-label">Jenis Kelamin</label>
                    <div class="d-flex">
                            <div class="mx-4">
                                <input class="form-check-input" type="radio" name="sex" id="gridRadios1" value="Laki-Laki">
                                <label class="form-check-label" for="gridRadios1">
                                    Laki-Laki
                                </label>
                            </div>
                            <div class="ml-2">
                                <input class="form-check-input" type="radio" name="sex" id="gridRadios2" value="Perempuan">
